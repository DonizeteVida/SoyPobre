...
private val LightColorScheme = lightColorScheme(
    ...
    surface = Color.White,
    onSurface = Color.Gray,                         // OutlinedTextField written text color, Button disabled color
    surfaceVariant = Color.Red,
    onSurfaceVariant = Color.Gray,                  // OutlinedTextField hint text color
    ...
    outline = Color.Gray,                           // OutlinedTextField border color
    outlineVariant = Color.Green,
    scrim = Color.Red,
    surfaceBright = Color.Red,
    surfaceContainer = Seashell,                    // DropDown floating background color
